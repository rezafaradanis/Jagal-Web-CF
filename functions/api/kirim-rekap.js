 ...
 */
import { cariLaga, kirimGambarKeDiscord, kirimKeDiscord, bacaCatatan, simpanCatatan } from './_rekap.js';
...
export async function onRequestPost({ request, env }) {
  ...
  if (sudah.has(id)) return balas(200, { ok: true, catatan: 'Laga ini sudah pernah dikirim.' });
